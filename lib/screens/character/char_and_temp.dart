  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> buildBoxSpring(int count) {
      ...
      switch(count){
        case 1: //상의
          buttons = [
            clothesPositionFromBottom(15, 30,colorOnPalette(const Color(0xFFfa223b))), //red
        ...
        case 2: //하의
          buttons = [
            ...
            clothesPositionFromBottom(15, 60,colorOnPalette(const Color(0xFFd2c19b))), //beige
            clothesPositionFromBottom(15, 90,colorOnPalette(const Color(0xFF574e46))), //brown
            clothesPositionFromBottom(15, 120,colorOnPalette(const Color(0xFF7c6375))), //pink
            clothesPositionFromBottom(15, 150,colorOnPalette(const Color(0xFF566556))), //khaki
            clothesPositionFromBottom(15, 180,colorOnPalette(const Color(0xFFb0c3d0))), //denim(연청)
            clothesPositionFromBottom(15, 210,colorOnPalette(const Color(0xFF122b5a))), //navy
    ...
    List<Widget> buildBoxSummer(int count) {
      ...
      switch(count){
        case 1: //상의
          buttons = [
            clothesPositionFromBottom(15, 30,colorOnPalette(const Color(0xFFd82727).withOpacity(0.97))),  //red/
            clothesPositionFromBottom(15, 60,colorOnPalette(const Color(0xFFfed3dc))),  //pink/
            clothesPositionFromBottom(15, 90,colorOnPalette(const Color(0xFFcfcca4))),  //yellow/
            clothesPositionFromBottom(15, 120,colorOnPalette(const Color(0xFFa4cfbe))), //mint/
            clothesPositionFromBottom(15, 150,colorOnPalette(const Color(0xFFa4b4cf))), //blue/
            clothesPositionFromBottom(15, 180,colorOnPalette(const Color(0xFF2c3346))), //navy
            clothesPositionFromBottom(15, 210,colorOnPalette(const Color(0xFFddc6f4))), //purple/
            clothesPositionFromBottom(15, 240,colorOnPalette(const Color(0xFFfcffff))), //white/
            clothesPositionFromBottom(15, 270,colorOnPalette(const Color(0xFFcbcbcb))), //gray/
            clothesPositionFromBottom(15, 300,colorOnPalette(const Color(0xFF2e2e2e))), //black/
          ];
          return buttons;
        case 2: //하의
          buttons = [
    ...
    List<Widget> buildBoxAutumn(int count) {
      ...
      switch(count){
        case 1: //상의
          buttons = [
            clothesPositionFromBottom(15, 30,colorOnPalette(const Color(0xFFcc4533))), //red
            clothesPositionFromBottom(15, 60,colorOnPalette(const Color(0xFFa9819d))), //pink
            clothesPositionFromBottom(15, 90,colorOnPalette(const Color(0xFF4b570b))), //green
            clothesPositionFromBottom(15, 120,colorOnPalette(const Color(0xFF65634c))), //khaki
            clothesPositionFromBottom(15, 150,colorOnPalette(const Color(0xFF272f5d))), //navy
            clothesPositionFromBottom(15, 180,colorOnPalette(const Color(0xFF5a3f5e))), //purple
            clothesPositionFromBottom(15, 210,colorOnPalette(const Color(0xFF6e4942))), //brown
            clothesPositionFromBottom(15, 240,colorOnPalette(const Color(0xFFebebeb))), //white
            clothesPositionFromBottom(15, 270,colorOnPalette(const Color(0xFF727272))), //gray
            clothesPositionFromBottom(15, 300,colorOnPalette(const Color(0xFF272727))), //black
          ];
    ...
    List<Widget> buildBoxWinter(int count) {
      ...
      switch(count){
        case 1: //상의
          buttons = [
            clothesPositionFromBottom(15, 30,colorOnPalette(const Color(0xFF7c0000).withOpacity(0.97))), //red
            clothesPositionFromBottom(15, 60,colorOnPalette(const Color(0xFFd55a96))), //pink
            clothesPositionFromBottom(15, 90,colorOnPalette(const Color(0xFFd0ca7c))), //yellow
            clothesPositionFromBottom(15, 120,colorOnPalette(const Color(0xFFa1d2c9))), //mint
            clothesPositionFromBottom(15, 150,colorOnPalette(const Color(0xFF255ac5))), //blue
            clothesPositionFromBottom(15, 180,colorOnPalette(const Color(0xFF2c3346))), //navy
            clothesPositionFromBottom(15, 210,colorOnPalette(const Color(0xFFb23d9d))),//purple
            clothesPositionFromBottom(15, 240,colorOnPalette(const Color(0xFFfcffff))), //white/
            clothesPositionFromBottom(15, 270,colorOnPalette(const Color(0xFF7e8085))), //gray
            clothesPositionFromBottom(15, 300,colorOnPalette(const Color(0xFF2e2e2e))), //black/
          ];
          return buttons;
        case 2: //하의
